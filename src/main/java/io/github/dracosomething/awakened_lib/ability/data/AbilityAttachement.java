...
public class AbilityAttachement implements INBTSerializable<CompoundTag> {
    private AbilityStorage storage = new AbilityStorage();
    ...
    public void addAbility(UUID objectUUID, TickingObject object) {
        storage.addAbility(objectUUID, object);
    }
